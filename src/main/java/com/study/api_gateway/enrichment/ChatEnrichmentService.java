...
import com.study.api_gateway.api.chat.dto.request.CreateDmRoomRequest;
...
public class ChatEnrichmentService {
	 ...
	 */
	public Mono<CreateDmRoomResponse> createDmRoomWithNickname(Long userId, CreateDmRoomRequest request) {
