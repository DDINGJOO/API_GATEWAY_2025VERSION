package com.study.api_gateway.domain.article.controller;

import com.study.api_gateway.common.dto.BaseResponse;
import com.study.api_gateway.common.response.ResponseFactory;
import com.study.api_gateway.domain.article.client.ArticleClient;
...
import com.study.api_gateway.domain.comment.CommentClient;
import com.study.api_gateway.domain.image.ImageConfirmService;
...
public class ArticleController {
	...
	private final com.study.api_gateway.domain.like.LikeClient likeClient;
	...
	public Mono<ResponseEntity<BaseResponse>> getArticle(@PathVariable String articleId, ServerHttpRequest req) {
		return Mono.zip(
				...
				.flatMap(tuple3 -> {
					...
					com.study.api_gateway.domain.article.dto.ArticleResponse ar = tuple3.getT1();
