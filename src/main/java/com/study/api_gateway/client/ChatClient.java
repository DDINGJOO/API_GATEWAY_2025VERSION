...
public class ChatClient {
	...
	private com.study.api_gateway.dto.chat.enums.ChatRoomType parseRoomType(Object value) {
		if (value == null) return null;
		try {
			return com.study.api_gateway.dto.chat.enums.ChatRoomType.valueOf(String.valueOf(value));
		} catch (Exception e) {
			return null;
		}
	}

	private com.study.api_gateway.dto.chat.enums.SupportStatus parseSupportStatus(Object value) {
		if (value == null) return null;
		try {
			return com.study.api_gateway.dto.chat.enums.SupportStatus.valueOf(String.valueOf(value));
		} catch (Exception e) {
			return null;
		}
	}
